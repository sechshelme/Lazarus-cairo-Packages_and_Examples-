...
function cairo_ft_font_face_create_for_ft_face(face: Pointer; load_flags: longint): Pcairo_font_face_t; cdecl; external cairo_lib;
...
function cairo_ft_scaled_font_lock_face(scaled_font: Pcairo_scaled_font_t): Pointer; cdecl; external cairo_lib;
...
function cairo_ft_font_face_create_for_pattern(pattern: Pointer): Pcairo_font_face_t; cdecl; external cairo_lib;
procedure cairo_ft_font_options_substitute(options: Pcairo_font_options_t; pattern: Pointer); cdecl; external cairo_lib;
